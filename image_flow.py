...
class SegDirectoryIterator(Iterator):
    ...
    def __init__(self, seg_data_generator,
                 data_paths, label_paths, label_suffix, classes, ignore_label=255,
        ...
        # Trying to make yield functionality
...
class SegDataGenerator(object):
    ...
    def flow_from_directory(self, data_paths, 
                            label_paths, label_suffix, classes,
                            ignore_label=255,
                            target_size=None, color_mode='rgb',
                            class_mode='sparse',
        ...
        return SegDirectoryIterator(self,
            data_paths=data_paths, 
            label_paths=label_paths, label_suffix=label_suffix,
